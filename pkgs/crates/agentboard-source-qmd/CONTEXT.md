# AgentBoard QMD Source Context

`agentboard-source-qmd` collects items from QMD collections and normalizes them into AgentBoard Items.
...
Read `.memory/docs/adr/pkgs/crates/agentboard-source-qmd/` before changing query handling, frontmatter mapping, or raw payload storage.
