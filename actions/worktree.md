...
Use `@clankpipe/action-worktree` to ensure each item has a Git worktree on its
...
Pair it with `@clankpipe/action-run-cmd` when you want to open the new worktree in a
