# Worktree action (/actions/worktree)



# Worktree action [#worktree-action]

Use `@agentboard/action-worktree` to ensure each item has a Git worktree on its
...
Pair it with `@agentboard/action-run-cmd` when you want to open the new worktree in a
